...
| `width` deprecated v0.1.20(使用`css`变量`--plus-sidebar-width` 代替) | 侧边栏不闭合时的宽度     | `number / string`                                                                       | `200`   | 否       |
| `renderTitle`                                                                                                                    | 自定义菜单每项标题显示   | `function`  |         | 否       |
| `renderMenuItem`                                                                                                                 | 自定义 菜单的 menuItem   | `function`  |         | 否       |
| `renderSubMenuItem`                                                                                                              | 自定义 菜单的 subMenu    | `function`  |         | 否       |
| `renderMenuExtra`                                                                                                                | 自定义在菜单头和菜单之间 | `function`  |         | 否       |
| ...                                                                                                                              | ...                      | ...                                                                                     | ...     | ...      |
...
| 名称                                    | 说明                                                                                 | 类型                                                                                                                              |
| --------------------------------------- | ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------- |
| `toggleCollapse`                        | 侧边栏闭合（开启）时触发                                                             | `function`                                                              |
| `clickMenuItem`v0.1.23 | 自定义点击菜单每一项的事件，**当此事件存在时原有的点击菜单路由跳转的事件将会失效**。 | `function`  |
