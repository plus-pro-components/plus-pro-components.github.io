...
支持 `left`、`right`、`center`(v0.1.28新增) 三种对齐方式。
...
| 名称                    | 说明     | 类型                                                                                                           | 默认值                                          | 是否必须 |
| ----------------------- | -------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- | -------- |
| `align`                 | 对齐方式 | `string`  （`center`v0.1.28 新增） | `right`                                         | 否       |
...
| 插槽名                                    | 说明                                                                                              |
| ----------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `pagination-left`v0.0.2  | 分页器左侧内容 ，`align` 为 `right` 或 `center`（v0.1.28 新增） 时生效。 |
| `pagination-right`v0.0.2 | 分页器右侧内容 ，`align` 为 `left` 或 `center`（v0.1.28 新增） 时生效。  |
